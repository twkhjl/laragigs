        ...
        <div class="py-16">
            <div class="mx-auto px-6 max-w-6xl text-gray-500">
                <div class="text-center">
                    <h2 class="text-3xl text-gray-950 dark:text-white font-semibold">列表頁</h2>
                    <p class="mt-6 text-gray-700 dark:text-gray-300">Harum quae dolore inventore repudiandae? orrupti
                        aut temporibus ariatur.</p>
                </div>
                    ...
                    @foreach ($listings as $key => $value)
                        <div
                            ...
                            <div class="p-5">
                                ...
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ $value['description'] }}
                                </p>
