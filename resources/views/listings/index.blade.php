  ...
  <section>
    <div class="py-16">
      <div class="mx-auto px-6 max-w-6xl text-gray-500">
        <div id="card-list-container" class="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <div id="load-more" class="text-center mt-6">
          <div role="status">
              <svg aria-hidden="true" class="inline w-12 h-12 text-gray-200 animate-spin dark:text-gray-600 fill-green-800" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
