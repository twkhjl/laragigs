<?php 
 ...
 return [
   ...
   "(and :count more errors)" => "（還有 :count 個錯誤）|（還有 :count 多個錯誤）|（還有 :count 多個錯誤）", 
   "30 Days" => "30天", 
   "365 Days" => "365天", 
   "60 Days" => "60天", 
   "90 Days" => "90天", 
   ":amount selected" => ":Amount個選擇", 
   ":amount Total" => ":Amount 總計", 
   ":days day trial" => ":Days 天試用", 
   ":resource Details" => ":Resource 詳細資料", 
   ":resource Details: :title" => ":Resource 詳細資料：:title", 
   "A fresh verification link has been sent to your email address." => "驗證連結已傳送到您的電子郵件地址。", 
   "A new verification link has been sent to the email address you provided during registration." => "新的驗證連結已傳送到您註冊時提供的電子郵件地址。", 
   "A new verification link has been sent to the email address you provided in your profile settings." => "新的驗證連結已傳送到您個人資料設定裡的電子郵件地址。", 
   "A new verification link has been sent to your email address." => "新的驗證連結已傳送到您的電子郵件地址。", 
   ...
   "Add a new team member to your team, allowing them to collaborate with you." => "新增一個新的團隊成員到您的團隊，讓他們與您合作。", 
   "Add additional security to your account using two factor authentication." => "使用雙重認證為您的帳號提高額外的安全性。", 
   "Add Payment Method" => "新增付款方式", 
   "Add row" => "新增列", 
   "Add Team Member" => "新增團隊成員", 
   "Add VAT Number" => "新增增值稅號碼 (統一編號)", 
   "Added." => "已新增。", 
   "Additional billing information updated successfully." => "額外的帳單資訊已成功更新。", 
   "Address" => "地址", 
   "Address Line 2" => "地址2", 
   "Administrator" => "系統管理員", 
   "Administrator users can perform any action." => "系統管理使用者可以執行任何操作。", 
   "Afghanistan" => "阿富汗", 
   "Aland Islands" => "奧蘭群島", 
   "Albania" => "阿爾巴尼亞", 
   "Algeria" => "阿爾及利亞", 
   "All of the people that are part of this team." => "所有人都是這個團隊的一部分。", 
   "All resources loaded." => "所有資源均已載入。", 
   "All rights reserved." => "版權所有。", 
   "Already registered?" => "已註冊？", 
   "American Samoa" => "美屬薩摩亞", 
   "An error occurred while uploading the file." => "上傳檔案時發生錯誤。", 
   "An error occurred while uploading the file: :error" => "上傳檔案時發生錯誤：:error", 
   "An unexpected error occurred and we have notified our support team. Please try again later." => "發生意外錯誤，我們已通知我們的支援團隊。 請稍後再試。", 
   "Andorra" => "安道爾", 
   "Angola" => "安哥拉", 
   "Anguilla" => "安圭拉", 
   ...
   "Antigua and Barbuda" => "安提瓜和巴布達", 
   "API Token" => "API 權杖 (token)", 
   "API Token Permissions" => "API 權杖的權限 (token)", 
   "API Tokens" => "API 權杖 (token)", 
   "API tokens allow third-party services to authenticate with our application on your behalf." => "API 權杖 (token) 允許協力廠商與我們的應用程式進行認證。", 
   "Apply" => "申請", 
   "Apply Coupon" => "申請優惠券", 
   "April" => "四月", 
   "Are you sure you want to attempt to pay :amount?" => "您確定要嘗試支付 :amount 美元嗎？", 
   "Are you sure you want to cancel your subscription?" => "您確定要取消訂閱嗎？", 
   "Are you sure you want to delete all the notifications?" => "您確定要刪除所有通知嗎？", 
   ...
   "Are you sure you want to delete your account? Once your account is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm you would like to permanently delete your account." => "您確定要刪除您的帳號嗎？一旦您的帳號被刪除，其所有資源和資料將被永久刪除。請輸入您的密碼，確認您要永久刪除您的帳號。", 
   ...
   "Are you sure you want to remove this item?" => "您確定要刪除該項目嗎？", 
   ...
   "Are you sure you want to resume your subscription?" => "您確定要還原訂閱嗎？", 
   "Are you sure you want to run this action?" => "您確定要執行此操作嗎？", 
   "Are you sure you want to set this payment method as your default?" => "您確定要將此付款方式設為預設付款方式嗎？", 
   "Are you sure you want to stop impersonating?" => "您確定要停止模擬登入嗎？", 
   "Are you sure you would like to delete this API token?" => "您確定要刪除這個 API 權杖 (token) 嗎？", 
   ...
   "Are you sure you would like to switch billing plans?" => "您確定要切換帳單計費方案嗎？", 
   "Argentina" => "阿根廷", 
   "Armenia" => "亞美尼亞", 
   "Aruba" => "阿魯巴", 
   "Attach" => "附加", 
   ...
   "Attach files by dragging & dropping, selecting or pasting them." => "透過拖拉、選擇或貼上檔案來附加檔案。", 
   "Attendance" => "考勤", 
   "August" => "八月", 
   "Australia" => "澳大利亞", 
   "Austria" => "奧地利", 
   ...
   "Bangladesh" => "孟加拉", 
   "Barbados" => "巴貝多", 
   "Before continuing, could you verify your email address by clicking on the link we just emailed to you? If you didn't receive the email, we will gladly send you another." => "在繼續之前，您可以點擊我們剛剛傳給給您的連結來驗證您的電子郵件地址，如果您沒有收到那封電子郵件，我們將很樂意再傳送一封給您。", 
   ...
   "City" => "城市", 
   "Click here to re-send the verification email." => "按一下這裡來重新傳送驗證電子郵件", 
   "click here to request another" => "按一下這裡來要求另一個", 
   "Click to choose" => "按一下來選擇", 
   "Close" => "關閉", 
   ...
   "Comoros" => "葛摩", 
   "Confirm" => "確認", 
   "Confirm Billing Action" => "確認帳單操作", 
   "Confirm Password" => "確認密碼", 
   "Confirm Payment" => "確認付款", 
   "Confirm your :amount payment" => "確認您的 :amount 付款資訊", 
   "Congo" => "剛果", 
   ...
   "Country" => "國家", 
   "Coupon" => "優惠券", 
   "Coupon applied successfully." => "優惠券應用成功。", 
   "Create" => "建立", 
   ...
   "Create Account" => "建立帳號", 
   "Create API Token" => "建立 API 權杖 (token)", 
   ...
   "Delete" => "刪除", 
   "Delete Account" => "刪除帳號", 
   "Delete all notifications" => "刪除所有通知", 
   "Delete API Token" => "刪除 API 權杖 (token)", 
   "Delete File" => "刪除檔", 
   ...
   "Disable" => "停用", 
   "Djibouti" => "吉布地", 
   "Do you really want to leave? You have unsaved changes." => "您真的想離開嗎？ 您還有未儲存的更動。", 
   "Dominica" => "星期日", 
   "Dominican Republic" => "多明尼加共和國", 
   "Done." => "已完成。", 
   "Download" => "下載", 
   "Download Receipt" => "下載收據", 
   "Drop file or click to choose" => "拖放檔案或點擊以選擇", 
   "Drop files or click to choose" => "拖放檔案或點擊以選擇", 
   "Ecuador" => "厄瓜多爾", 
   "Edit" => "編輯", 
   ...
   "Email Password Reset Link" => "寄出重設密碼連結", 
   "Employee" => "員工", 
   "Enable" => "啟用", 
   "Ensure your account is using a long, random password to stay secure." => "確保您的帳號使用夠長且隨機的密碼來確保安全。", 
   ...
   "Expires :expiration" => "過期 :expiration", 
   ...
   "Failed Subscription Payment" => "訂閱付款失敗", 
   "Failed to load :resource!" => "無法載入 :resource！", 
   "Falkland Islands (Malvinas)" => "福克蘭群島(馬維納斯)", 
   "Faroe Islands" => "法羅群島", 
   "February" => "二月", 
   "Fiji" => "斐濟", 
   "Filename" => "檔案名稱", 
   "Finish enabling two factor authentication." => "完成啟用雙重認證。", 
   "Finland" => "芬蘭", 
   "For your security, please confirm your password to continue." => "為了安全起見，在繼續前請先輸入您的密碼。", 
   "Forbidden" => "拒絕存取", 
   "Force Delete" => "強制刪除", 
   ...
   "Forgot Your Password?" => "忘記密碼？", 
   "Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one." => "忘記密碼？沒關係。請輸入您的電子郵件地址，我們將透過電子郵件傳送重設密碼連結給您，讓您重新設定一個新的密碼。", 
   "France" => "法國", 
   "French Guiana" => "法屬圭亞那", 
   ...
   "Iceland" => "冰島", 
   "ID" => "ID", 
   "If necessary, you may log out of all of your other browser sessions across all of your devices. Some of your recent sessions are listed below; however, this list may not be exhaustive. If you feel your account has been compromised, you should also update your password." => "如有必要，您可以登出您在其它裝置上的所有瀏覽器工作階段。下方列出了您最近的一些工作階段；但這個列表可能並不詳盡。如果您認為您的帳號已被入侵，您還應該更新您的密碼。", 
   "If you already have an account, you may accept this invitation by clicking the button below:" => "如果您已有帳號，您可以透過點擊下方的按鈕接受這個邀請：", 
...
into your web browser:" => "如果您點擊「:actionText」按鈕時出現問題，請複製下方連結至瀏覽器中貼上：", 
   ...
   "Manage API Tokens" => "管理 API 權杖 (token)", 
   "Manage Role" => "管理角色", 
   "Manage Team" => "管理團隊", 
   "Managing billing for :billableName" => "管理 :billableName 的帳單", 
   "March" => "三月", 
   ...
   "No Increase" => "不增加", 
   "No payment methods on file." => "沒有已設定之付款方式。", 
   "No payment scheduled." => "沒有排定之付款。", 
   ...
   "of" => "於", 
   "Oman" => "阿曼", 
   "Once a team is deleted, all of its resources and data will be permanently deleted. Before deleting this team, please download any data or information regarding this team that you wish to retain." => "一旦團隊被刪除，其所有資源和資料將被永久刪除。在刪除該團隊之前，請下載您希望保留的有關該團隊的任何資料或資訊。", 
   ...
   "Open Invoices" => "打開發票", 
   "Original" => "原創", 
   "Our billing management portal allows you to conveniently manage your subscription plan, payment method, and download your recent invoices." => "我們的帳單管理頁面可以讓您方便地管理訂閱方案、付款方式以及下載近期的發票。", 
   "Our billing management portal allows you to conveniently manage your subscription plan, payment methods, and download your recent invoices." => "我們的帳單管理頁面可以讓您方便地管理訂閱方案、付款方式以及下載近期的發票。", 
   "Page Expired" => "頁面已過期", 
   ...
   "Payment information updated successfully." => "付款資訊更新成功。", 
   "Payment Method" => "付款方式", 
   ...
   "Permanently delete your account." => "永久刪除您的帳號", 
   "Permissions" => "權限", 
   "Person" => "人", 
   "Peru" => "秘魯", 
   "Philippines" => "菲律賓", 
   ...
   "Please confirm access to your account by entering one of your emergency recovery codes." => "請輸入您的緊急還原碼以存取您的帳號。", 
   "Please confirm access to your account by entering the authentication code provided by your authenticator application." => "請輸入您的認證器應用程式提供的驗證碼以存取您的帳號。", 
   "Please confirm your password before continuing." => "請在繼續前確認您的密碼。", 
   "Please copy your new API token. For your security, it won't be shown again." => "請複製您的新 API 權杖 (token)。為了您的安全，它不會再被顯示出來。", 
   ...
   "Please set a default payment method before swapping plans." => "請在更換方案前設定預設付款方式。", 
   "Poland" => "波蘭", 
   "Portugal" => "葡萄牙", 
   ...
   "Puerto Rico" => "波多黎各", 
   "Qatar" => "卡達", 
   "Quarter To Date" => "本季至今", 
   "Receipt Email Addresses" => "收據電子郵件地址", 
   "Receipt emails updated successfully." => "收據電子郵件已成功更新。", 
   "Receipts" => "收據", 
   "Recovery Code" => "復原碼", 
   "Refresh" => "刷新", 
   "Regards" => "致敬", 
   "Regenerate Recovery Codes" => "重新產生復原碼", 
   "Register" => "註冊", 
   "Reload" => "重新載入", 
   "Remember me" => "記住我", 
   "Remember Me" => "記住我", 
   ...
   "Resend Verification Email" => "重新傳送驗證電子郵件", 
   "Reset Filters" => "重設篩選器", 
   "Reset Password" => "重設密碼", 
   "Reset Password Notification" => "重設密碼通知", 
   "resource" => "資源", 
   "Resource Row Dropdown" => "資源列下拉", 
   "Resources" => "資源", 
   "resources" => "資源", 
   "Restore" => "還原", 
   ...
   "Select a log file..." => "選擇記錄檔...", 
   "Select A New Photo" => "選擇新的照片", 
   "Select Action" => "選擇操作", 
   "Select all" => "全選", 
   "Select All Dropdown" => "選擇所有下拉菜單", 
   "Select this page" => "選擇此頁面", 
   ...
   "Sorry, your session has expired." => "對不起，您的工作階段已過期。", 
   "South Africa" => "南非", 
   ...
   "Stop Polling" => "停止輪詢", 
   "Stop polling" => "停止輪詢", 
   "Store these recovery codes in a secure password manager. They can be used to recover access to your account if your two factor authentication device is lost." => "將這些復原碼儲存在一個安全的密碼管理器中。如果您的兩步驟驗證裝置遺失，它們可以用來重新取得您帳號的存取權。", 
   "Subscribe" => "訂閱", 
   ...
   "Thailand" => "泰國", 
   "Thanks for signing up! Before getting started, could you verify your email address by clicking on the link we just emailed to you? If you didn't receive the email, we will gladly send you another." => "感謝您的註冊！在開始之前，您可以點擊我們剛剛寄給您的連結來驗證您的電子郵件地址，如果您沒有收到那封電子郵件，我們將很樂意再傳送一封給您。", 
   ...
   "The action was executed successfully." => "動作執行成功。", 
   "The default payment method cannot be removed." => "無法刪除預設付款方式。", 
   ...
   "The government won't let us show you what's behind these doors" => "政府不會讓我們向您展示這些門後面的東西", 
   "The HasOne relationship has already been filled." => "HasOne 的關係已經被填上了。", 
   "The image could not be loaded" => "圖片無法載入", 
   "The image could not be loaded." => "圖片無法載入。", 
   "The password is incorrect." => "密碼不正確。", 
   "The provided coupon code is invalid." => "優惠券代碼無效。", 
   "The provided password does not match your current password." => "目前密碼不正確。", 
   "The provided password was incorrect." => "密碼錯誤。", 
   "The provided two factor authentication code was invalid." => "雙重認證碼無效。", 
   "The provided two factor recovery code was invalid." => "雙重證證復原碼無效。", 
   "The provided VAT number is invalid." => "增值稅號碼 (統一編號) 無效。", 
   "The receipt emails must be valid email addresses." => "收據電子郵件必須是有效的電子郵件地址。", 
   "The resource was attached!" => "資源已附加！", 
   "The resource was prevented from being saved!" => "資源不能被儲存！", 
   ...
   "There are no available options for this resource." => "這個資源沒有可用的選項。", 
   "There are no fields to display." => "沒有顯示的欄位。", 
   "There are no new notifications." => "沒有新通知。", 
   "There is no active subscription." => "沒有活動的訂閱。", 
   "There was a problem executing the action." => "執行操作時出現問題。", 
   "There was a problem fetching the resource." => "取得資源時出現問題。", 
   "There was a problem submitting the form." => "送出表單時出現問題。", 
   ...
   "This account does not have an active subscription." => "這個帳號沒有有效的訂閱。", 
   "This action is unauthorized." => "此操作未經授權。", 
   "This copy of Nova is unlicensed." => "目前使用的 Nova 未取得授權。", 
   "This coupon code can only be used by new customers." => "這個優惠券序號只能由新客戶使用。", 
   "This device" => "目前裝置", 
   "This file field is read-only." => "這個檔案欄位是唯讀的。", 
   "This invoice is no longer open." => "此發票不再打開。", 
   ...
   "This resource no longer exists" => "資源不再存在", 
   "This subscription cannot be resumed. Please create a new subscription." => "訂閱無法還原。 請重新訂閱。", 
   "This subscription has expired and cannot be resumed. Please create a new subscription." => "訂閱已過期，無法還原。請重新訂閱。", 
   "This user already belongs to the team." => "使用者已經在團隊中。", 
   "This user has already been invited to the team." => "使用者已經被邀請加入團隊。", 
   "Timor-Leste" => "東帝汶", 
   "to" => "至", 
   "To" => "到", 
   "To finish enabling two factor authentication, scan the following QR code using your phone's authenticator application or enter the setup key and provide the generated OTP code." => "為了完成雙重認證設定，請使用您手機的認證器應用程式掃描以下的 QR code，或輸入設定金鑰並提供產生的 OTP 碼。", 
   "Today" => "今天", 
   "Toggle navigation" => "切換導覽", 
   "Togo" => "多哥", 
   "Tokelau" => "托克勞", 
   "Token Name" => "權杖 (token) 名稱", 
   "Tonga" => "東加", 
   ...
   "Two factor authentication is now enabled. Scan the following QR code using your phone's authenticator application or enter the setup key." => "雙重認證已啟用。 使用手機的認證器應用程式掃描以下的 QR code，或輸入設定金鑰。", 
   "Type" => "類型", 
   "Uganda" => "烏干達", 
   "Ukraine" => "烏克蘭", 
   "Unauthorized" => "未授權", 
   ...
   "Uploading" => "上傳中", 
   "Uploading files... (:current/:total)" => "上傳檔案... (:current/:total)", 
   "Uruguay" => "烏拉圭", 
   ...
   "We are unable to process your payment. Please contact customer support." => "我們無法處理您的付款。 請與客戶服務聯絡。", 
   "We have emailed your password reset link!" => "我們已經寄出您的重設密碼連結！", 
   "We were unable to find a registered user with this email address." => "我們無法找到這個電子郵件地址的註冊使用者。", 
   "We will send a receipt download link to the email addresses that you specify below. You may separate multiple email addresses using commas." => "我們將傳送下載收據的連結至您在下方指定的電子郵件地址。 您可以用逗號分隔多個電子郵件地址。", 
   "We're lost in space. The page you were trying to view does not exist." => "我們迷失在太空中 您嘗試查看的頁面不存在。", 
   "Welcome Back!" => "歡迎回來！", 
   "Western Sahara" => "西撒哈拉", 
   "When two factor authentication is enabled, you will be prompted for a secure, random token during authentication. You may retrieve this token from your phone's Google Authenticator application." => "當啟用雙重認證時，在認證過程中會提示您輸入一個安全且隨機的權杖 (token)。您可以從手機的 Google Authenticator 應用程式中獲得此權杖 (token)。", 
   "Whoops" => "哎呀", 
   "Whoops!" => "哎呀！", 
   ...
   "You are currently within your free trial period. Your trial will expire on :date. Starting a new subscription will end your trial." => "您目前正處於免費試用期內。您的試用期將於 :date. 到期 開始新的訂閱將結束您的試用期。", 
   ...
   "You have enabled two factor authentication." => "您已經啟用了雙重認證。", 
   "You have not enabled two factor authentication." => "您還沒有啟用雙重認證。", 
   "You have some unpaid invoices. After updating your default payment method, you may retry the payments via the invoice list below." => "您有一些未付的發票。更新您的預設付款方式後，您可以透過以下的發票列表重新嘗試付款。", 
   "You may accept this invitation by clicking the button below:" => "您可以點擊下方的按鈕接受此邀請：", 
   "You may cancel your subscription at any time. Once your subscription has been cancelled, you will have the option to resume the subscription until the end of your current billing cycle." => "您可以隨時取消訂閱。 取消訂閱後，您可以選擇在目前帳單計費週期結束之前還原訂閱。", 
   "You may delete any of your existing tokens if they are no longer needed." => "如果不再需要，您可以刪除任何現有的權杖 (token)。", 
   "You may not delete your personal team." => "您不能刪除您的個人團隊。", 
   "You may not leave a team that you created." => "您不能離開您建立的團隊。", 
   "You will receive an invoice and payment link via email for each billing period." => "您將透過電子郵件收到每個帳單計費週期的發票和付款連結。", 
   "You're logged in!" => "您已登入！", 
   "Your :invoiceName invoice is now available!" => "您的 :invoiceName 發票已可取用！", 
   "Your billing address is :address :address2 :postal_code :city :state :country" => "您的帳單地址是 :address :address2 :postal_code :city :state :country", 
   "Your card was declined. Please contact your card issuer for more information." => "您的信用卡遭到拒絕。請聯絡您的發卡機構以了解更多資訊。", 
   ...
   "Your last payment of :amount on :date failed. Please update your payment method to retry the failed payment." => "您上次 :date :amount 付款失敗。請更新您的付款方式以重試失敗的付款。", 
   "Your next payment of :amount will be processed on :date." => "您的下一筆 :amount 付款將在 :date 付款。", 
   "Your payment method has been added successfully." => "您的付款方式已新增成功。", 
   "Your payment method will be charged automatically for each billing period." => "您的付款方式將在每個帳單計費週期自動收費。", 
   "Your registered VAT Number is :vatNumber." => "您註冊的增值稅號碼 (統一編號) 是 :vatNumber.", 
   "Your subscription has been started successfully." => "您的訂閱已開始。", 
   "Your subscription has been successfully cancelled." => "您的訂閱已取消。", 
   "Your subscription was successfully resumed." => "您的訂閱已還原。", 
   "Your subscription was successfully updated." => "您的訂閱已更新。", 
   "Zambia" => "尚比亞", 
   "Zimbabwe" => "辛巴威", 
